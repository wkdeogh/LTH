    ...
    <div className="stack page-stack guide-page">
      ...
      <section className="guide-section" id="normal">
        ...
        <div className="guide-copy">
          ...
          <div className="rule-list">
            ...
            <div><span>하락 보완</span><p>기본 매수 수량만큼 1주 LOC 주문을 아래 가격에 추가합니다. 가격은 <strong>1회 매수금 ÷ 체결 후 누적수량</strong>을 센트 단위로 버려 계산하므로, 종가가 내려가도 실제 매수금이 1회분에 가깝게 채워집니다.</p></div>
          </div>
      ...
      <section className="guide-section" id="reverse">
        ...
        <div className="guide-copy">
          ...
          <h3>둘째 날부터</h3>
          <p>별지점 위에서는 일부 매도하고, 별지점 아래에서는 현재 현금의 1/4만큼 매수합니다.</p>
