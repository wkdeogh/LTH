...
create table executions (
  ...
  round_id uuid references completed_rounds(id) on delete set null,
...
## 5.5 completed_rounds

전량 매도로 종료된 라운드의 수익과 요약 체결 통계를 저장합니다.
